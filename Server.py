...
def initialize_organisms():
	Flare_plus = Ability('Flare+: Attacks for 25 HP and matches 2 random columns.', (0,5), ((1,-1),(1,-1)), 0, False, None, None, 8)
	Flare = Ability('Flare: Attacks for 20 HP and matches a random column.', (0,20), ((1,-1)), 0, False, None, None, 8)
	Bonzire = Organism('Bonzumi', Flare_plus, 'fire', None)
	Bonzumi = Organism('Bonzumi', Flare, 'fire', Bonzire)

	Hydro_Rush_plus = Ability('Hydro Rush+: Attacks for 20 HP and converts 23random tiles to Water.', (0,20), None, 3, False, None, None, 6)
	Hydro_Rush = Ability('Hydro Rush: Attacks for 10 HP and converts 2 random tiles to Water.', (0,10), None, 2, False, None, None, 6)
	Sephanix = Organism('Sephanix', Hydro_Rush_plus, 'water', None)
	Pelijet = Organism('Pelijet', Hydro_Rush, 'water', Sephanix)

	Heal_Leaf_plus = Ability('Heal Leaf+: Attacks for 15HP and heals you for 15HP.', (10,10), None, 0, False, None, None, 6)
	Heal_Leaf = Ability('Heal Leaf: Attacks for 10HP and heals you for 10HP.', (10,10), None, 0, False, None, None, 6)
...
organism_choices = '\n'.join([str(organism) for organism in stage_1_organisms])
